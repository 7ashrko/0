...
PS4["13.50"] = Object.assign({}, PS4["13.04"], {
    alias_of: null,
    fw_status: "state=PARTIAL official-kernel-offsets-applied webkit=UNVERIFIED kpatch=UNVERIFIED",

    // Verified against the supplied/official 13.50 kernel offset data.
    ...
    // Do not reuse an unverified kernel patch for 13.52.
    kpatch: null,
});

PS4["13.52"] = Object.assign({}, PS4["13.04"], {
    alias_of: null,
    fw_status: "state=PARTIAL official-kernel-offsets-applied webkit=UNVERIFIED kpatch=UNVERIFIED",

    // Verified against the supplied/official 13.52 kernel offset data.
    XFAST_SYSCALL_addr:                  0x000001C0,
    PRISON0_addr:                        0x0111FA18,
    ROOTVNODE_addr:                      0x02136E90,
    M_TEMP_addr:                         0x01520D00,
    ...
    // Deliberately unset: no verified 13.52 patch file was established.
    kpatch: null,
});
